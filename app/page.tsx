          ...
          >
            <div className="relative md:max-w-xl">
              <img
                src="/your-image.png"
                alt=""
                className="absolute w-40 lg:w-52 left-56 
      ...
      <section className="bg-slate-100 py-4">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            inset-x-0 -bottom-6 text-green-500"
                />
              </span>{" "}
              say
            </h2>
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-large leading-8">
                <p>
                  ...
                  <span className="p-0.5 bg-slate-800 text-white font-bold">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-large leading-8">
                <p>
                  "I absolutely love this phone case! The design is sleek, and
                  it fits my phone perfectly. It's durable and has already saved
                  my phone from a couple of drops. The material feels premium,
                  and the colors are vibrant. Plus, the customer service was
                  fantastic-quick responses and super helpful.{" "}
                  <span className="p-0.5 bg-slate-800 text-white font-bold">
                    Highly recommend
                  </span>
                  this brand to anyone looking for quality phone cases!"
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              max-w-sm bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg w-fit space-y-2">
            <li className="w-fit">
