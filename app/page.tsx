      ...
      <section>
        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            flex flex-col items-center lg:items-center">
                ...
                Your Image on a <span className="bg-green-600 px-2 text-white">
                  ...
                  sm:items-start gap-5">
                    <div className="flex -space-x-4">
                      <img src="/users/user-1.png" alt="user image" className="inline-block h-10 w-10 rounded-full
                      ring-2 ring-slate-100"/>
                      <img src="/users/user-2.png" alt="user image" className="inline-block h-10 w-10 rounded-full
                      ring-2 ring-slate-100"/>
                      <img src="/users/user-3.png" alt="user image" className="inline-block h-10 w-10 rounded-full
                      ring-2 ring-slate-100"/>
                      <img src="/users/user-4.jpg" alt="user image" className="inline-block h-10 w-10 rounded-full
                      ring-2 ring-slate-100"/>
                      <img src="/users/user-5.jpg" alt="user image" className="inline-block h-10 w-10 rounded-full
                      ring-2 ring-slate-100 object-cover"/>
                    </div>

                    <div className="flex flex-col justify-between items-center sm:item-start">
                      <div className="flex gap-0.5">
                        <Star className="h-4 w-4 fill-green-600 text-green-500"/>
                        <Star className="h-4 w-4 fill-green-600 text-green-500"/>
                        <Star className="h-4 w-4 fill-green-600 text-green-500"/>
                        <Star className="h-4 w-4 fill-green-600 text-green-500"/>
                        <Star className="h-4 w-4 fill-green-600 text-green-500"/>
          ...
          sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              <img src="/your-image.png" alt="" className="absolute w-40 lg:w-52 left-56 
      ...
      <section className="bg-slate-100 py-4">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            !leading-tight font-bold text-5xl md:text-6xl text-gray-900">What our <span className="relative 
            px-2">customers <Icons.Underline className='hidden sm:block pointer-events-none absolute 
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-large leading-8">
                <p>
                  ...
                  Had the case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is 
                  super clear
                  </span>
