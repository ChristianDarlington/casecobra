...
const DesignConfigurator = ({
  ...
  return <div className="relative mt-20 grid grid-cols-3 mb-20 pb-20">
    ...
    <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
      <AspectRatio ratio={891/ 1831} className="pointer-events-none relative z-50 aspect-[896/1831]">
        <NextImage fill alt="pic" src='/phone-template.png' className="pointer-events-none z-50 select-none"/>
      </AspectRatio>
    </div>
    </div>
  </div>
